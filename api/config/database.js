...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'john.doe', 'john.doe@john.com', '123', 'John Doe' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'john.doe')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'mary', 'mary@app.com', '123', 'Mary Christmas' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'mary')
`;
